...
const cucumberJsonDir = './apps/picking-e2e/cucumber-json';
const cucumberReportFileMap = {};
const cucumberReportMap = {};
const jsonIndentLevel = 2;
const htmlReportDir = './apps/picking-e2e/reports';
const screenshotsDir = './apps/picking-e2e/cypress/screenshots';
...
function generateReport() {
  if (!fs.existsSync(cucumberJsonDir)) {
    ...
    report.generate({
      ...
      reportName: `Cucumber Test Report - ${new Date().toLocaleString()}`,
      hideMetadata: true,
    });
  }
}
