...
interface AddBagLabelsCollectPopupPropTypes {
...
const AddBagLabelsCollectPopup: React.FC<AddBagLabelsCollectPopupPropTypes> = ({ labelCountDetails, onConfirm }) => {
...
export { AddBagLabelsCollectPopup };
