...
interface PrintedDeliveryLabelConfirmationPopupPropTypes {
  labelDetails: PrintDeliveryBagLabels;
  onClose: () => void;
}
...
const PrintedDeliveryLabelConfirmationPopup: React.FC<PrintedDeliveryLabelConfirmationPopupPropTypes> = ({
  labelDetails,
  onClose,
}) => {
...
export { PrintedDeliveryLabelConfirmationPopup };
